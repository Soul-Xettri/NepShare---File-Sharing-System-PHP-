...
<div class="container-fluid">
	<div class="card card-widget widget-user shadow">
      <div class="widget-user-header bg-dark">
        <h3 class="widget-user-username"><mark style="background-color:#fcf8e3;color:black;border-radius: 5px;padding:0;font-weight: 500;"><?php echo ucwords($name) ?></mark><br></h3>
        <h5 class="widget-user-desc" style="padding-top:10px;"><mark style="background-color:#fcf8e3;color:black;border-radius: 5px;padding:0;font-weight: 400;"><?php echo $email ?></mark></h5>
      </div>
