<div class="col-lg-12">
	<div class="card card-outline card-primary" style="background-color: #fff;box-shadow: 0px 20px 20px #08010196;width: 100%;border-radius: 5px;min-height: 50vh;padding: 20px;text-align: center;">
		<div class="card-body" style="background-color: #fff;box-shadow: 0px 7px 20px #08010196;width: 100%;border-radius: 5px;padding: 20px;text-align: center;">
        ...
        <input type="hidden" name="id" value="<?php echo isset($id) ? $id : '' ?>">
			...
			<div class="callout callout-info" style="background-color: #f5f7ff;box-shadow: -3px 10px 20px #08010196;">
            <div id="actions" class="row">
              ...
              <div class="col-lg-6 d-flex align-items-center">
                <div class="fileupload-process w-100">
                  <div id="total-progress" class="progress progress-striped active" role="progressbar" aria-valuemin="0" aria-valuemax="100" aria-valuenow="0" style="background-color: #343a40;">
    	...
    	<div class="card-footer border-top border-info"style="background-color: #fff;box-shadow: 0px 20px 20px #08010196;width: 100%;border-radius: 5px;padding: 20px;text-align: center;"  >
